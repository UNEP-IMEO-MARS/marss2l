...
def to_mbmp(
    ...
    b11_index: Optional[int] = None,
    b12_index: Optional[int] = None,
    b11_index_prev: Optional[int] = None,
    b12_index_prev: Optional[int] = None,
) -> torch.Tensor:
    """
    ...
    ratio_prev[b11_prev_not_zero] = ratio_prev[b11_prev_not_zero] / (
        ratio_prev[b11_prev_not_zero].median()
    )
