...
def plot_geographical_location(
    lon: float, lat: float, ax: Optional[plt.Axes] = None, text_annotation: Optional[str] = None
) -> plt.Axes:
    """
    ...
    m = Basemap(projection="ortho", lat_0=lat_viewing_angle, lon_0=lon_viewing_angle, ax=ax)
