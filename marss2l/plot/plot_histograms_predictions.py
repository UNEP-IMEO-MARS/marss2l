...
def plot_row(
    ...
    model_name: str = "MARS S2L",
    max_plumes_hist: int = None,
    max_images_hist: int = None,
    ...
    nimages, bins, patches = axs[0].hist(
        data.scene_pred[data.target == 0],
        zorder=2,
        alpha=0.8,
        linewidth=1.5,
        edgecolor="black",
    ...
    nplumes, bins, patches = axs[1].hist(
        data.scene_pred[data.target == 1],
        zorder=2,
        alpha=0.8,
        linewidth=1.5,
        edgecolor="black",
    ...
    if add_text:
        ...
        axs[0].text(
            0.12,
            max_images_hist - np.rint(max_images_hist * 0.1),
            f"True negatives = {TN}",
            fontsize=12,
        )
        axs[0].text(
        ...
        axs[1].text(
            0.12,
            max_plumes_hist - np.rint(max_plumes_hist * 0.1),
