...
def get_scenelevel_metrics(
    scene_pred_cont: NDArray, target: NDArray, threshold: float = 0.5, as_percentage: bool = False
) -> Dict[str, float]:
    ...
    return {
        "average_precision": float(avr_precision),
...
def get_pixellevel_metrics(
    ...
    return {
        "segmentation_precision": float(precision),
