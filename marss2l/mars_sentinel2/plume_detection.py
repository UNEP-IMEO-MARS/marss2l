...
def binary_connected_prediction(
    ...
    labels, nclusters = measure.label(
        pred_discrete, connectivity=2, return_num=True
    )  # detect clusters and store their properties
...
def count_connected_pixels(
    ...
    """
    binary_pred = binary_connected_prediction(
        pred_continuous, threshold_prediction, threshold_pixels
    )
